...
double _calculateBubbleRadius(BubbleSeriesRenderer _seriesRenderer,
  ...
  final BubbleSeries<dynamic, dynamic> bubbleSeries =
      _seriesRenderer._series as BubbleSeries<dynamic, dynamic>;
